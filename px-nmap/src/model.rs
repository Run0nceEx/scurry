...
impl FromStr for Protocol {
    ...
    fn from_str(x: &str) -> Result<Self, Self::Err> {
        Ok(match x.trim() {
            ...
            x => return Err(
            //    ErrorKind::UnknownToken(format!("Got \"{}\" instead of 'tcp' or 'udp'", x))
            unimplemented!()
        ) 
        })
    }
...
impl FromStr for Directive {
    ...
    fn from_str(x: &str) -> Result<Self, Self::Err> {
        Ok(match x.trim() {
            ...
            _ => return Err(
                unimplemented!()
                //ErrorKind::UnknownToken("Got \"{}\" instead of match or softmatch".to_string())
            ) 
        })
    }
}
...
pub struct ProbeExpr {
    ...
    pub wait_total_ms: Option<Duration>,
}